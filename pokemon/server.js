...
// var request = new sapcai.request("fdb6ed6f88547ffee329f22cae5279b0", 'en');
var request = new sapcai.request("b95b4a147a9b59f1ace0f236475c303a", 'en');
request.analyseText('set parameter')
  .then(function(res) {
    console.log(res.raw);
  });
// Load routes 
